...
include_once $GLOBALS['THRIFT_ROOT'].'/lib/Thrift/Protocol/TProtocol.php';
include_once $GLOBALS['THRIFT_ROOT'].'/lib/Thrift/Transport/TTransport.php';
include_once $GLOBALS['THRIFT_ROOT'].'/src/TStringUtils.php';
